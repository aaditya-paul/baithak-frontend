...
import { Mic, MicOff, Video, VideoOff, ChevronDown, Flame } from "lucide-react";
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen p-6 gap-12 bg-background">
      ...
      >
        <video
          ...
          muted
          playsInline
          className={cn("w-full h-full object-cover transition-opacity duration-300", isVideoOff && "opacity-0")}
        />
        {isVideoOff && (
            <motion.div 
        ...
        >
             <motion.button
                ...
                className={cn(
                  ...
                  isMuted ? "bg-destructive text-destructive-foreground" : "bg-secondary hover:bg-accent text-foreground"
                )}
              >
              ...
              <motion.button
                ...
                className={cn(
                  "p-2.5 rounded-full transition-all",
                  isVideoOff ? "bg-destructive text-destructive-foreground" : "bg-secondary hover:bg-accent text-foreground"
                )}
              >
      ...
      >
           ...
           >
               ...
               <p className="text-muted-foreground text-sm">Check your camera and mic before joining.</p>
           </motion.div>
